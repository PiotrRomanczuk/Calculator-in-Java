...
public class Main {
	...
	public static void main(String[] args) {
		example(null);
		// Exercise 1: Based on the output you observed, what is the difference between %d, %7d, %07d, %-7d and %7.3f?
		//	%d		- Formats the integer to be output without manipulation
		//	%7d		- Puts spaces in front of the integer to fill the remainder of 7 characters
		//	%07d	- Instead of filling the remainder with spaces, it is specified that the remainder should be filled with "0"
		//	%-7d	- The effect of %7d but in a reverse order, filling the remainder of 7 characters with spaces after the integer
		//	%7.3f	- Spaces are put in front of the float to fill the remainder of 7 characters and the float is formatted to have 3 decimals
		...
		System.out.println("\nExercise 4");
		// Exercise 4: Print the string '0032,12000' by formatting the float number 32.12.
		//	010 specifies that the total length should be 10 characters and .5f specifies to fill the remainder of the next 5 characters with 0
