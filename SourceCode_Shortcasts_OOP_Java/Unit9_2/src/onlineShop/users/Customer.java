...
//		this.minimumOrderValue = 10.0;
	...
	public double getMinimumOrderValue() 
			throws MinimumOrderValueNegativeException{
		if(this.minimumOrderValue >= 0){
			return minimumOrderValue;
		}else{
			//throw new MinimumOrderValueNegativeException();
			throw new MinimumOrderValueNegativeException("This is a test Exception-text 222");
		}
